...
public class B_排名规则 {
     ...
     * Description
     *
     * 我们在ACM的题目中已经了解了什么是ACM了，ACM还是很残酷的了（ಥ _ ಥ），那么现在你就要解决一个ACM最简单的题了，
     * 简单到省赛和区域赛都不会出这种简单的题。ls很强，即使每年都在ACM这个大坑里，但是他依旧关心自己的排名。但是排名规则真的很令人烦恼，
     * 因为它是按平均分排的并且他们学习的科目数量是不一定的。所以你的任务就来了，ls的班里有n名同学，每个同学有3门课程，
     * 现在你要根据他们的成绩总和从大到小排名如果成绩相同则按他们名字的字典序（字典序当然就是字典的顺序啦）排名。
     *
     *
     * Input
     *
